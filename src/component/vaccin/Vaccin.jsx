...
class Vaccin extends Component{
    constructor(props){
        ...
        this.state={
            etatAjout : false,
            designation : {value: '',etat : 0},
            nbrInjection : {value: 1,etat : 0},
            interaction : {value: 1,etat : 0},
            description : {value: '',etat : 0},
    ...
    setStateByNameState(name,valeur,etatChamps){
		if(name === 'designation')this.setState({ designation : { value : valeur , etat : etatChamps }}); 
