                                            ...
                                            this.state.listContact.map((contact,i)=>{
                                                return(
                                                    <td key={i}>
                                                        ...
                                                        <a href={contact.valeurContact} rel="noopener noreferrer" target="_blank" className="btn-floating btn-tw">
                                                        ...
                                                        <a rel="noopener noreferrer" target="_blank" href={contact.valeurContact} className="btn-floating btn-tw">
