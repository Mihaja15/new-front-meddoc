...
class Footer extends React.Component{
    ...
    render(){
        return(
            <div className="page-footer font-small mdb-color lighten-3 pt-4 footer-area">
                ...
                <div className="footer-copyright text-center py-3">Copyright: &ensp;<span className="copyrightFooter"><b>MEDDoC</b></span>&nbsp; © {this.state.copyright.getFullYear()}</div>
