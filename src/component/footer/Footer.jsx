                ...
                <div className="container">
                    <div className="row">
                        <div className="col-md-12 row">
                            <div className="col-md-2 col-lg-2 mr-auto my-md-4 my-0 mt-4 mb-1">
                        ...
                        <div className="footer-copyright col-md-12 text-center py-3">Copyright  ©  {this.state.copyright.getFullYear()} <span className="copyrightFooter"><b>MEDDoC</b></span></div>
                    </div>
                </div>
            </div>
        )
