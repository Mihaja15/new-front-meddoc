...
export default class RechercheMedecin extends React.Component{
    constructor(props){
        super();
        this.state={
            page:0,
                            ...
                            return (
                                <div className="row each-line-search" key={i} onMouseOver={()=>{this.setState({indiceIcon :i, setIcon : true, position : [data.adresse.latitude,data.adresse.longitude]})}}>
                                    ...
                                    <div className="col-md-8 col-sm-12 each-line-search-emploi-temps">
                                        <EmploiTemps centre={data} idCentre={data.idCentre} link={"/professionnel/schedule"} setDataCentre={this.changeCentre} /*changeStateShow={this.changeStateShow}*//>
